...
class WpProQuiz_View_QuizOverall extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_quizOverall questionQuizContainer">
            <div class="denvorLogWrap">
                <img src="<?php echo WPPROQUIZ_DP_COVER_IMAGE; ?>" />
            </div>
            <h2 class="wp-core-ui leftWrap">
                <div>
                    <span class="overviewTitle"><?php _e('Quiz Overview', 'wp-pro-quiz'); ?></span>
                    <?php if (current_user_can('wpProQuiz_add_quiz')) { ?>
                            <a class="button-primary" href="admin.php?page=wpProQuiz&action=addEdit"><?php echo __('Add Quiz', 'wp-pro-quiz'); ?></a>
                    <?php } if (current_user_can('wpProQuiz_import')) { ?>
                        <a class="button wpProQuiz_import importBtnWrap" href="#"><?php echo __('Import', 'wp-pro-quiz'); ?></a>
                    <?php } ?>
                </div>
            </h2>
