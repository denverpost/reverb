...
class WpProQuiz_View_StatisticsNew extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_statisticsNew">
            ...
            <h2 class="pageTitle"><?php printf(__('Quiz: %s - Statistics', 'wp-pro-quiz'), $this->quiz->getName()); ?></h2>
            <input type="hidden" id="quizName" value="<?php echo $this->quiz->getName(); ?>" name="quizName">


            <p>
                <a class="backBtn" href="admin.php?page=wpProQuiz"><?php _e('Back to overview',
                        'wp-pro-quiz'); ?></a>
<!--                <a class="button-secondary" href="admin.php?page=wpProQuiz&module=exportCSV&quizId=--><?php //echo $this->quiz->getId(); ?><!--">--><?php //_e('Export to CSV','wp-pro-quiz'); ?><!--</a>-->
            </p>
            ...
            <div class="wpProQuiz_tab_wrapper historyBtnWrap">
                <a class="button-primary historyBtn" href="#" data-tab="#wpProQuiz_tabHistory"><?php _e('History',
                        'wp-pro-quiz'); ?></a>                
                <?php if(!$this->checkPhotoOrGiveAwayQuiz()){ ?>
                <a class="button-secondary secBtnWrap" href="#" data-tab="#wpProQuiz_tabOverview"><?php _e('Overview',
                        'wp-pro-quiz'); ?></a>
                <?php } ?>
                <input type="button" value="<?php _e('Export CSV', 'wp-pro-quiz'); ?>" class="button-secondary" id="export_csv">
