...
class WpProQuiz_View_GobalSettings extends WpProQuiz_View_View
{
    ...
    public function show()
    {
        ...
        <div class="wrap wpProQuiz_globalSettings">
            ...
            <h3 class="pageTitle"><?php _e('Global settings', 'wp-pro-quiz'); ?></h3>

            <a class="backBtn backBtnSpacing" href="admin.php?page=wpProQuiz"><?php _e('Back to overview',
                    'wp-pro-quiz'); ?></a>

            <div class="wpProQuiz_tab_wrapper globalBtnWrap">
                <a class="button-primary primaryBtnWrap" href="#" data-tab="#globalContent"><?php _e('Global settings',
                        'wp-pro-quiz'); ?></a>
                <a class="button-secondary secBtnWrap" href="#" data-tab="#problemContent"><?php _e('Settings in case of problems',
                        'wp-pro-quiz'); ?></a>
            </div>
    ...
    private function globalSettings()
    {
        ...
        <div class="postbox">
            ...
            <div class="inside">
                <table class="form-table globalSettingsTable">
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset class="alignMiddleWrap">
                                <legend class="screen-reader-text alignMiddleWrap">
                                    <span><?php _e('Statistic time format', 'wp-pro-quiz'); ?></span>
                                </legend>

                                <label class="alignMiddleWrap">
                                ...
                                <div class="alignMiddleWrap">
                                    <label>
                                        <?php _e('Time format:', 'wp-pro-quiz'); ?>:
                                        <input class="medium-text alignMiddleWrap" name="statisticTimeFormat"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Quiz Type management', 'wp-pro-quiz'); ?>
                        </th>
                        <td>
                            <fieldset class="alignMiddleWrap">
                                <legend class="screen-reader-text alignMiddleWrap">
                                    <span><?php _e('Quiz Type management', 'wp-pro-quiz'); ?></span>
                                </legend>
                                <select name="categoryQuiz" class="alignMiddleWrap">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset class="alignMiddleWrap">
                                ...
                                <select name="templateQuiz" class="alignMiddleWrap">
                    ...
                    <tr>
                        ...
                        <td>
                            <fieldset class="alignMiddleWrap">
                                ...
                                <select name="templateQuestion" class="alignMiddleWrap">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Facebook App Id', 'wp-pro-quiz'); ?>
                        </th>
                        <td>
                            <fieldset class="alignMiddleWrap">
                                <legend class="screen-reader-text alignMiddleWrap">
                                    <span><?php _e('Facebook App Id', 'wp-pro-quiz'); ?></span>
                                </legend>
                                <input type="number" class="regular-text" name="facebookAppId" step="1" min="0" id="facebookAppId" value="<?php echo $this->settings->getFacebookAppId(); ?>">
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="thumbnail_width" type="number" id="thumbnail_width" step="1" min="0" value="<?php echo $this->settings->getThumbnailWidth(); ?>" class="small-text">
                    
                            <label for="thumbnail_height">Height</label>
                            <input name="thumbnail_height" type="number" id="thumbnail_height" step="1" min="0" value="<?php echo $this->settings->getThumbnailHeight(); ?>" class="small-text"><br>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                          <?php
                            wp_editor($this->settings->getPrivacyPolicy(), "privacy_policy", array('textarea_rows' => 6));
                          ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                          <?php
                            wp_editor($this->settings->getTermsConditions(), "terms_conditions", array('textarea_rows' => 6));
                          ?>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">Contest rules</th>
                        <td>
                          <?php
                            wp_editor($this->settings->getContestRules(), "contest_rules", array('textarea_rows' => 6));
                          ?>
                        </td>
                    </tr>
                    </tbody>
