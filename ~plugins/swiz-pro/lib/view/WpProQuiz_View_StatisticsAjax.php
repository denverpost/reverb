    ...
    public function showHistoryTable()
    {
        ...
        <table class="wp-list-table widefat">
            ...
            <tr>
                ...
                <?php if(!$this->checkPhotoOrGiveAwayQuiz() && !$this->checkThisThatQuiz()){ ?>
                        ...
                        <th>
							...
							<span>
                                ...
                                <?php
                                    ...
                                    $field_id = $formMapper->ApproveFieldId($model->getQuizId());
                                    $formData = $model->getFormData();
                                    if(isset($formData[$field_id])){
                                        $approveStatus = ($formData[$field_id] == "1") ? 1 : 0;
                                        $approveText = ($formData[$field_id] == "1") ? "Disapprove" : "Approve";
                                    }
                                    if($this->checkPhotoOrGiveAwayQuiz(true)){
                                ?>
                                <a style="color: blue;" class="wpProQuiz_approve" href="#" dataApproveStatus="<?php echo $approveStatus; ?>"><?php echo $approveText; ?></a>
                                <?php } ?>
							</span>
                            </div>
                        </th>
    ...
    <?php } ?>
        ...
        <table class="wp-list-table widefat" style="margin-top: 20px;">
            ...
            foreach ($this->userStatistic as $cat) {
                ...
                ?>
                <tr class="categoryTr" style="display: none;">
                    <th colspan="9">
                                    ...
                                    <td>
                                        ...
                                        switch ($form->getType()) {
                                            ...
                                            case WpProQuiz_Model_Form::FORM_TYPE_FILE:
                                                $image = "<a href='".$str."' target='_blank'><img src='".$str."' height='".ADMIN_PC_IMAGE_HEIGHT."' width='".ADMIN_PC_IMAGE_WIDTH."' /></a>";
                                                echo $image;
                                                break;
                                        }
                                        ?>
