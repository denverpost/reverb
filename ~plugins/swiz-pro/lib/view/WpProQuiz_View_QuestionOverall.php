...
<div class="wrap quizWrapper wpProQuiz_questionOverall">
	...
	<p class="leftWrap btnContainer">
		<?php if(current_user_can('wpProQuiz_edit_quiz')) { ?>
			<a class="backBtn" href="admin.php?page=wpProQuiz&action=addEdit&quizId=<?php echo $this->quiz->getId(); ?>"><?php _e('Back to edit quiz', 'wp-pro-quiz'); ?></a>
			<?php if(current_user_can('wpProQuiz_edit_quiz')) { ?>
				<a class="button-primary addQuestionBtn" href="?page=wpProQuiz&module=question&action=addEdit&quiz_id=<?php echo $this->quiz->getId(); ?>"><?php _e('Add question', 'wp-pro-quiz'); ?>
					
				</a>
			<?php } ?>

			<div class="sortQuestionWrap">
				<a class="button-secondary" id="sortQuestionBtn" href="#"><?php _e('Sort questions', 'wp-pro-quiz'); ?></a>
	...
	<form method="get" class="questionDashboard">
