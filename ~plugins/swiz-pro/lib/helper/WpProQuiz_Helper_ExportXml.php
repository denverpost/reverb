...
class WpProQuiz_Helper_ExportXml
{
    ...
    private function getQuizElement($dom, $quiz, $forms)
    {
        ...
        $quizElement->appendChild($dom->createElement('facebookShare',$this->booleanToTrueOrFalse($quiz->isFacebookShare())));
        $quizElement->appendChild($dom->createElement('twitterShare',$this->booleanToTrueOrFalse($quiz->isTwitterShare())));
        $quizElement->appendChild($dom->createElement('linkedinShare',$this->booleanToTrueOrFalse($quiz->isLinkedinShare())));
        $quizElement->appendChild($dom->createElement('emailShare',$this->booleanToTrueOrFalse($quiz->isEmailShare())));

        $quizElement->appendChild($dom->createElement('isPrivacyPolicy',$this->booleanToTrueOrFalse($quiz->isPrivacyPolicy())));
        $quizElement->appendChild($dom->createElement('isTermsConditions',$this->booleanToTrueOrFalse($quiz->isTermsConditions())));
        $quizElement->appendChild($dom->createElement('isContestRules',$this->booleanToTrueOrFalse($quiz->isContestRules())));
        $quizElement->appendChild($dom->createElement('privacyPolicy', $quiz->getPrivacyPolicy()));
        $quizElement->appendChild($dom->createElement('termsConditions', $quiz->getTermsConditions()));
        $quizElement->appendChild($dom->createElement('contestRules', $quiz->getContestRules()));
        $quizElement->appendChild($dom->createElement('privacyPolicyText', $this->esacapeHtmlTags($quiz->getPrivacyPolicyText())));
        $quizElement->appendChild($dom->createElement('termsConditionsText', $this->esacapeHtmlTags($quiz->getTermsConditionsText())));
        $quizElement->appendChild($dom->createElement('contestRulesText', $this->esacapeHtmlTags($quiz->getContestRulesText())));
        
        $quizElement->appendChild($dom->createElement('quizStyle', $this->esacapeHtmlTags($quiz->getQuizStyle())));
        $quizElement->appendChild($dom->createElement('customQuizBox', $quiz->getCustomQuizBox()));

        $quizElement->appendChild($dom->createElement('categoryValue', $quiz->getCategoryValue()));
        $quizElement->appendChild($dom->createElement('customFormHeader', $quiz->getCustomFormHeader()));
        $quizElement->appendChild($dom->createElement('isCustomFormHeader',$this->booleanToTrueOrFalse($quiz->isCustomFormHeader())));
        $quizElement->appendChild($dom->createElement('embedCode', $quiz->getEmbedCode()));

        $quizElement->appendChild($dom->createElement('pcLeftHeader', $quiz->getPcLeftHeader()));
        $quizElement->appendChild($dom->createElement('pcCenterHeader', $quiz->getPcCenterHeader()));
        $quizElement->appendChild($dom->createElement('pcRightHeader', $quiz->getPcRightHeader()));
        $quizElement->appendChild($dom->createElement('pcLeftHeaderTitle', $quiz->getPcLeftHeaderTitle()));
        $quizElement->appendChild($dom->createElement('pcCenterHeaderTitle', $quiz->getPcCenterHeaderTitle()));
        $quizElement->appendChild($dom->createElement('pcRightHeaderTitle', $quiz->getPcRightHeaderTitle()));
        $quizElement->appendChild($dom->createElement('pcDescription', $quiz->getPcDescription()));
        $quizElement->appendChild($dom->createElement('quizSharingDescription', $quiz->getQuizSharingDescription()));
    ...
    /**
     *  Removes html special char and return new string
     *  @param string $str
     *  @return string
    */
    private function esacapeHtmlTags($str)
    {
