...
class WpProQuiz_Controller_Ajax
{
    ...
    private function initCallbacks()
    {
        $this->_adminCallbacks = array(
            ...
            'statisticExportCsv' => array('WpProQuiz_Controller_CSV', 'ajaxExportCsv'),
            ...
            'statisticResetApproveNew' => array('WpProQuiz_Controller_Statistics', 'ajaxRestApproveStatistic'),
            ...
            'getQuizStyleSheet' => array('WpProQuiz_Controller_Quiz', 'getQuizStyleSheet'),
            'deleteStyleSheet' => array('WpProQuiz_Controller_Quiz', 'deleteStyleSheet'),
            'loadPcImages' => array('WpProQuiz_Controller_Front', 'loadPcImages'),
            'setPCEmailTemplate' => array('WpProQuiz_Controller_Quiz', 'setPCEmailTemplate')
        );
