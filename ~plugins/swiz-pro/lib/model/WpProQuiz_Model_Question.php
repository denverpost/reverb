...
class WpProQuiz_Model_Question extends WpProQuiz_Model_Model
{
    ...
    /**
     * Sets this that quiz votes count
     * @param string $_isContestRules
     */
    public function setThisThatVotes($_thisThatVotes)
    {
        $this->_thisThatVotes = (string)$_thisThatVotes;
     ...
     * Sets this that quiz votes count
     */
    public function getThisThatVotes()
    {
        return $this->_thisThatVotes;
    }
}
