...
class WpProQuiz_Model_QuizMapper extends WpProQuiz_Model_Mapper
{
    ...
    public function save(WpProQuiz_Model_Quiz $data)
    {
        ...
        $set = array(
            ...
            'quiz_style' => $data->getQuizStyle(),
            'custom_quiz_box' => $data->getCustomQuizBox(),
            ...
            'facebook_share' => (int)$data->isFacebookShare(),
            'twitter_share' => (int)$data->isTwitterShare(),
            'email_share' => (int)$data->isEmailShare(),
            'linkedin_share' => (int)$data->isLinkedinShare(),
            ...
            'privacy_policy' => $data->getPrivacyPolicy(),
            'terms_conditions' => $data->getTermsConditions(),
            'contest_rules' => $data->getContestRules(),
            'privacy_policy_text' => $data->getPrivacyPolicyText(),
            'terms_conditions_text' => $data->getTermsConditionsText(),
            'contest_rules_text' => $data->getContestRulesText(),
            'is_privacy_policy' => (int)$data->isPrivacyPolicy(),
            'is_terms_conditions' => (int)$data->isTermsConditions(),
            'is_contest_rules' => (int)$data->isContestRules(),
            'custom_form_header' => $data->getCustomFormHeader(),
            'is_custom_form_header' => (int)$data->isCustomFormHeader(),
            'embed_code' => $data->getEmbedCode(),
            'pc_left_header' => $data->getPcLeftHeader(),
            'pc_center_header' => $data->getPcCenterHeader(),
            'pc_right_header' => $data->getPcRightHeader(),
            'pc_description' => $data->getPcDescription(),
            'pc_left_header_title' => $data->getPcLeftHeaderTitle(),
            'pc_center_header_title' => $data->getPcCenterHeaderTitle(),
            'pc_right_header_title' => $data->getPcRightHeaderTitle(),
            'quiz_sharing_description' => $data->getQuizSharingDescription()
        );
     ...
     * @return array
     */
    public function updateCustomStyle(WpProQuiz_Model_Quiz $data)
    {
        $set = array(
            'quiz_style' => $data->getQuizStyle(),
            'custom_quiz_box' => $data->getCustomQuizBox(),
     ...
     * @return array
     */
    public function updateEmbedCode(WpProQuiz_Model_Quiz $data)
    {
        $set = array(
            'embed_code' => $data->getEmbedCode(),
        );
