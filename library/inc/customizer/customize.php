...
if ( !function_exists('reactor_customize_register') ) {
	...
	function reactor_customize_register( $wp_customize ) {
		...
		if ( in_array('top-bar-l', $menus[0] ) || in_array('top-bar-r', $menus[0] ) ) {
			...
			$wp_customize->add_setting('reactor_options[topbar_sticky]', array( 
				'default'        => 0,
				'type'           => 'option',
				'capability'     => 'manage_options',
				'transport'      => 'postMessage',
				...
				$wp_customize->add_control('reactor_options[topbar_sticky]', array( 
					'label'    => __('Sticky Top Bar', 'reactor'),
					'section'  => 'reactor_customizer_nav',
					'type'     => 'checkbox',
					'priority' => 4,
				 ) );
			...
			$wp_customize->add_setting('reactor_options[topbar_search]', array( 
				'default'        => 1,
				'type'           => 'option',
				'capability'     => 'manage_options',
				'transport'      => 'postMessage',
				...
				$wp_customize->add_control('reactor_options[topbar_search]', array( 
					'label'    => __('Enable Top Bar Search', 'reactor'),
					'section'  => 'reactor_customizer_nav',
					'type'     => 'checkbox',
					'priority' => 6,
				 ) );
