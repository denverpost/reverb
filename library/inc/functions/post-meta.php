...
if ( !function_exists('reactor_post_meta') ) {
	function reactor_post_meta( $args = '' ) {
		...
		if ( get_post_meta( get_the_ID(), 'original_author_name', true ) != '' ) {
			...
			$authorraw = ( !$args['show_photo'] ) ? '<span class="author">By <a class="url fn n" href="%1$s" rel="author"><strong>%2$s</strong></a>%3$s</span>' : '<h4 class="author"><a class="url fn n" href="%1$s" rel="author">%2$s</a></h4>';
